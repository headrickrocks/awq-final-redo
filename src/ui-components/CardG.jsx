...
export default function CardG(props) {
  const { accomplishment, overrides, ...rest } = props;
  const imageOnClick = useNavigateAction({
    type: "url",
    url: `${"/car/"}${accomplishment?.id}`,
  });
  const badgeOnClick = useDataStoreDeleteAction({
