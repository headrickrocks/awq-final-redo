  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Logo30602862")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Logo"
          {...getOverrideProps(overrides, "Logo30602864")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130602865")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Quiz"
          {...getOverrideProps(overrides, "Company30602869")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Login"
          {...getOverrideProps(overrides, "Company30602886")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Profile"
          {...getOverrideProps(overrides, "Company30602887")}
        ></Text>
      </Flex>
      <Flex
        gap="32px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130602870")}
      >
        <SearchField
          display="flex"
          gap="8px"
